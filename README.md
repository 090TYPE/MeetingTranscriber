...
| Вкладка записи | История сессий |
|:---:|:---:|
| ![Экран записи — источник (микрофон/файл), волновая форма, AI-резюме и экспорт в TXT/PDF/SRT](screenshots/record.png) | ![История транскрибированных встреч](screenshots/history.png) |

<sub>Содержимое истории — демонстрационные данные.</sub>
